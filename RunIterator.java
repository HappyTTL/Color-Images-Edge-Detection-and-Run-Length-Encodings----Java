...
public class RunIterator implements Iterator {
  ...
  // the encoding.
  RunIterator(DListNode start, DList list) {
  ...
  public int[] next() {
    ...
    // Replace the following line with your solution.
      if (hasNext()) {
          start = start.next;
          int[] item = new int[4];
          item[0] = start.runItem.red;
          item[1] = start.runItem.green;
          item[2] = start.runItem.blue;
          item[3] = start.runItem.runLengths;
